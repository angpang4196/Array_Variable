...
public class StringChar10 {
	...
	public static void main(String[] args) {
		...
		// 문자를 덧셈 연결해서 문자열로 변환시킬 수 없을까?
		String s2 = "" + 'C' + 'D';
		String s3 = String.valueOf(('C' + 'D'));
		// 67 + 68을 덧셈 수행한 후 결과를 문자열로 바꾼 것
		String s4 = String.valueOf('C') + String.valueOf('D');
		...
		// char[] 배열을 문자열로 바꾸기
		String char2str = new String(charNation, 0, charNation.length);
